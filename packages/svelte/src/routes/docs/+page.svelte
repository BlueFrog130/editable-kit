...
<section class="mb-16">
	...
	<p class="mt-4 max-w-xl text-lg leading-relaxed text-muted-foreground">
		...
		>, and images &mdash; without compromising performance, safety, or prerendering.
	</p>
</section>
		...
		<div class="rounded-lg border border-border p-4">
			...
			<p class="mt-1 text-xs leading-relaxed text-muted-foreground">
				<a
					...
					target="_blank"
					rel="noopener noreferrer">TipTap</a
				> and the toolbar are lazily imported. Until a user toggles editing, none of that code is loaded.
				Your visitors get a static page with no editor overhead.
			</p>
		</div>
		<div class="rounded-lg border border-border p-4">
